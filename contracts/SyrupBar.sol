...
contract SyrupBar is ERC20("Kaco Shiden SyrupBar", "SYRUP"), Ownable {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "Kaco::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "Kaco::delegateBySig: invalid nonce"
        );
        require(
            block.timestamp <= expiry,
            "Kaco::delegateBySig: signature expired"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "Kaco::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "Kaco::_writeCheckpoint: block number exceeds 32 bits"
        );
